...
int ShaderProgram::loadShader(std::string file, unsigned int type) const
{
...
void ShaderProgram::loadVector2(int location, sf::Vector2f value)
{
    glUniform2f(location, value.x, value.y);
}

void ShaderProgram::loadVector3(int location, sf::Vector3f value)
{
...
void ShaderProgram::loadMatrix(int location, std::vector<float> value)
{
